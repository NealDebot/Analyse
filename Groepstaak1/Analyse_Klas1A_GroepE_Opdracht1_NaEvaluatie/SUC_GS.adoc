...
. Het systeem vraagt de nodige gegevens: naam, voornaam, rekeningnummer, rijksregisternummer
. De [underline]#klant# geeft de gevraagde gegevens
. Het systeem valideert de gegevens volgens link:DR.adoc[DR_GS]
. Het systeem vraagt hoeveel geld gestort moet worden en op welke rekening
. De [underline]#klant# geeft het bedrag en de rekening
. Het systeem noteert het bedrag
. Het systeem verandert het bedrag op de rekening
. Het systeem geeft de klant een bewijs van storting
. De use case eindigt
